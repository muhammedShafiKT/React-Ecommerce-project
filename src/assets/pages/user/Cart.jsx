        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              {loading && (
                <>
                  {Array.from({ length: 3 }).map((_, i) => (
                    <div
                      key={i}
                      className="flex gap-6 border-b border-[#c8a97e]/10 pb-8"
                    >
                      <div className="shimmer w-24 h-32 shrink-0 rounded-sm" />

                      <div className="flex-1 flex flex-col justify-between space-y-4">
                        <div className="space-y-3">
                          <div className="shimmer block h-5 w-2/3 rounded" />
                          <div className="shimmer block h-4 w-1/3 rounded" />
                        </div>

                        <div className="flex items-center justify-between mt-4">
                          <div className="shimmer block h-8 w-28 rounded" />
            ...
            <div className="lg:col-span-1">
              {loading ? (
                <div className="bg-[#1a140e]/40 border border-[#c8a97e]/10 p-8 sticky top-32 space-y-6">
                  <div className="shimmer block h-4 w-24 rounded" />
                  <div className="shimmer block h-8 w-48 rounded" />
                  <div className="shimmer block h-12 w-full rounded" />
                  <div className="shimmer block h-4 w-56 mx-auto rounded" />
                </div>
              ) : (
